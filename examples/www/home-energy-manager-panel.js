...
const HOME_ENERGY_MANAGER_PANEL_BUILD = "174";
  ...
  _renderPricingGroupSelector(groups = [], activeGroup = null) {
    ...
    return `
      <div class="pricing-group-selector-row">
        ...
        <a class="panel-nav__item pricing-rule__button pricing-rule__button--delete ${activeGroup?.group_id ? "" : "is-disabled"}" data-pricing-action-link="add_group" data-pricing-ui-add-group href="${this._pricingActionHref("add_group", {
